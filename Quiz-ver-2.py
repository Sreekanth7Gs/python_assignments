...
def use_lifeline(remaining_lifelines):
    if remaining_lifelines > 0:
        print("You have used a lifeline to skip this question.")
        return True
    else:
        print("You've already used your lifeline for this game. You cannot skip another question.")
        return False

remaining_lifelines = 1  
...
Q1 = "Q1. The World's Largest desert is?"
choice = "A. Thar B. Kalahari C. Sahara D. Sonoran"
print(Q1)
print(choice)
print("Enter your choice or type 'SKIP' to use a lifeline")
...
if user_choice == 'C':
    ...
    count_easy += 1
    score_easy += lvl_easy()
elif user_choice == 'SKIP' and use_lifeline(remaining_lifelines):
    remaining_lifelines -= 1
else:
    print("Your Wrong")
...
total_correct = count_easy + count_mdm + count_easy
